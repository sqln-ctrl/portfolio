...
function Profile() {
  ...
  return (
    ...
    >
      <div className="flex h-[350px] w-[290px] mt-4 m-auto rounded-full overflow-hidden max-[1200px]:w-[275px] max-[1200px]:h-[275px] max-[1200px]:mx-auto max-[1200px]:mb-8 max-[600px]:w-auto max-[600px]:h-[46vw] ml-20">
      ...
      <div className="self-center text-center mr-20 mt-10 flex flex-col items-center gap-3">
        ...
        <div className="flex justify-center items-center gap-6 px-8 py-2 bg-[#1f1f1f] mt-4 rounded-lg w-fit shadow-lg shadow-black/20">
          <FontAwesomeIcon
            icon={faLinkedin}
            className="cursor-pointer text-xl text-gray-400 hover:text-white hover:scale-110 transition-all duration-200"
            onClick={() =>
